...
<script src="<?php echo URL; ?>public/js/history.js" type="text/javascript"></script>
...
<script src="<?php echo URL; ?>public/js/jquery-sharrre.min.js" type="text/javascript"></script>
